...
fallback_env = os.environ.get('FALLBACK_KEYWORDS', 'artificial intelligence, technology, robot, digital network, abstract tech')
...
# Screenshot ke aadhar par repo name update kiya gaya hai
repo_name = os.environ.get('GITHUB_REPOSITORY', "anjalikumari2792000-blip/AI-Tools-Hindi-Long") 
video_link = None
